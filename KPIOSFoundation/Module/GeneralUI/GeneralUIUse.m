...
+ (void)AddLineUpDown:(UIView *)l_view Color:(UIColor *)l_color{
    ...
    if (up_line && [up_line isKindOfClass:[UIView class]]) {
        ...
        up_line = [[UIView alloc]initWithFrame:CGRectMake(0, 0, l_view.frame.size.width, 0.5)];
    ...
    if (down_line && [down_line isKindOfClass:[UIView class]]) {
        ...
        down_line = [[UIView alloc]initWithFrame:CGRectMake(0, l_view.frame.size.height - 0.5, l_view.frame.size.width, 0.5)];
...
+ (void)AddLineDown:(UIView *)l_view Color:(UIColor *)l_color LeftOri:(CGFloat)ori_l RightOri:(CGFloat)oti_r{
    ...
    down_line = [[UIView alloc]initWithFrame:CGRectMake(ori_l, l_view.frame.size.height - 0.5, l_view.frame.size.width - ori_l - oti_r, 0.5)];
    [down_line setTag:DownLineTag];
    [down_line setBackgroundColor:l_color];
...
+ (void)AddLineRight:(UIView *)l_view Color:(UIColor *)l_color UpOri:(CGFloat)ori_up DownOri:(CGFloat)ori_down{
    ...
    left_line = [[UIView alloc]initWithFrame:CGRectMake(l_view.frame.size.width - 0.5, ori_up, 0.5, l_view.frame.size.height - ori_up - ori_down)];
